...
(assert (or (and (= mode1_1 true) (connect holder_4 flow_2))
            (and (= mode1_1 false) (connect holder_4 flow_3))))
(assert (not (and (connect holder_4 flow_2) (connect holder_4 flow_3))))
(assert (or (and (= mode2_1 true)  (connect holder_5 flow_4))
            (and (= mode2_1 false) (connect holder_5 flow_5))))
...
(assert (or (and (= mode1_2 true) (connect holder_7 flow_2))
            (and (= mode1_2 false) (connect holder_7 flow_3))))
(assert (not (and (connect holder_7 flow_2) (connect holder_7 flow_3))))
(assert (or (and (= mode2_2 true)  (connect holder_8 flow_4))
            (and (= mode2_2 false) (connect holder_8 flow_5))))
...
(assert (or (and (= mode1_3 true) (connect holder_10 flow_2))
            (and (= mode1_3 false) (connect holder_10 flow_3))))
(assert (not (and (connect holder_10 flow_2) (connect holder_10 flow_3))))
(assert (or (and (= mode2_3 true)  (connect holder_11 flow_4))
            (and (= mode2_3 false) (connect holder_11 flow_5))))
(assert (not (and (connect holder_11 flow_4) (connect holder_11 flow_5))))
(assert (not (or (< x1_3_t (- 5 2)) (> x1_3_t (+ 5 2)))))
(assert (not (or (< x2_3_t (- 5 2)) (> x2_3_t (+ 5 2)))))
(check-sat)
(exit)
