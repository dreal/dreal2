...
//typedef filib::interval<double, filib::pred_succ_rounding> interval;
typedef filib::interval<double, filib::pred_succ_rounding, filib::i_mode_extended> interval;
...
void rp_interval_sqrt(rp_interval result, rp_interval i)
{
    ...
    DREAL_LOG_DEBUG << "rp_interval: " << "sqrt([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
...
void rp_interval_exp(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "exp([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_log(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "log([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_sin(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "sin([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_cos(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "cos([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_tan(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "tan([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_cosh(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "cosh([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_sinh(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "sinh([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_tanh(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "tanh([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
//    interval t(rp_binf(i), rp_bsup(i));
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "asin([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
//    interval t(rp_binf(i), rp_bsup(i));
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "acos([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_atan(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "atan([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_asinh(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "asinh([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_acosh(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "acosh([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_atanh(rp_interval result, rp_interval i)
{
    ...
    rp_binf(result) = t.inf();
    rp_bsup(result) = t.sup();
    DREAL_LOG_DEBUG << "rp_interval: " << "atanh([" << rp_binf(i) << ", " << rp_bsup(i) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
    return;
...
void rp_interval_matan(rp_interval result, rp_interval x)
{
    ...
    */
    ...
    DREAL_LOG_DEBUG << "rp_interval: " << "matan([" << rp_binf(x) << ", " << rp_bsup(x) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
}
...
//    printf("atan2(y, x) = ");
//    rp_interval_display_simple_nl(result);
    DREAL_LOG_DEBUG << "rp_interval: " << "atan2([" << rp_binf(y) << ", " << rp_bsup(y) << "], "
                    << "[" << rp_binf(x) << ", " << rp_bsup(x) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
}
...
void rp_interval_nthroot(rp_interval result, rp_interval i, rp_interval n)
{
    ...
    DREAL_LOG_DEBUG << "rp_interval: " << "nthroot([" << rp_binf(i) << ", " << rp_bsup(i) << "], "
                    << "[" << rp_binf(n) << ", " << rp_bsup(n) << "]) = "
                    << "[" << rp_binf(result) << ", " << rp_bsup(result) << "]";
}
