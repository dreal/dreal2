...
# 4 steps (1/3, 1/2, 2/3, 1) * 0.5
cont_cond[1] = ["""
(assert (or (and (= modeA_{0} true)  (connect holder_{1} flow_2))
            (and (= modeA_{0} false) (connect holder_{1} flow_3))))
...
# 4 steps (1/3, 1/2, 2/3, 1) * 0.5
cont_cond[2] = ["""
(assert (or (and (= modeR_{0} true)  (connect holder_{2} flow_4))
            (and (= modeR_{0} false) (connect holder_{2} flow_5))))
