...
(assert (or (and (= modeA_{0} true) (= modeR_{0} true)
                 (= [xRDR_{0}_t xAIL_{0}_t tau_{0}_t r_{0}_t psi_{0}_t
                     phi_{0}_t p_{0}_t gRDR_{0}_t gAIL_{0}_t gDir_{0}_t beta_{0}_t]
                    (integral 0. time_{0} 
                       [xRDR_{0}_0 xAIL_{0}_0 tau_{0}_0 r_{0}_0 psi_{0}_0 
                        phi_{0}_0 p_{0}_0 gRDR_{0}_0 gAIL_{0}_0 gDir_{0}_0 beta_{0}_0] flow_1)))
            (and (= modeA_{0} true) (= modeR_{0} false)
                 (= [xRDR_{0}_t xAIL_{0}_t tau_{0}_t r_{0}_t psi_{0}_t
                     phi_{0}_t p_{0}_t gRDR_{0}_t gAIL_{0}_t gDir_{0}_t beta_{0}_t]
                    (integral 0. time_{0} 
                       [xRDR_{0}_0 xAIL_{0}_0 tau_{0}_0 r_{0}_0 psi_{0}_0 
                        phi_{0}_0 p_{0}_0 gRDR_{0}_0 gAIL_{0}_0 gDir_{0}_0 beta_{0}_0] flow_2)))
            (and (= modeA_{0} false) (= modeR_{0} true)
                 (= [xRDR_{0}_t xAIL_{0}_t tau_{0}_t r_{0}_t psi_{0}_t
                     phi_{0}_t p_{0}_t gRDR_{0}_t gAIL_{0}_t gDir_{0}_t beta_{0}_t]
                    (integral 0. time_{0} 
                       [xRDR_{0}_0 xAIL_{0}_0 tau_{0}_0 r_{0}_0 psi_{0}_0 
                        phi_{0}_0 p_{0}_0 gRDR_{0}_0 gAIL_{0}_0 gDir_{0}_0 beta_{0}_0] flow_3)))
            (and (= modeA_{0} false) (= modeR_{0} false)
                 (= [xRDR_{0}_t xAIL_{0}_t tau_{0}_t r_{0}_t psi_{0}_t
                     phi_{0}_t p_{0}_t gRDR_{0}_t gAIL_{0}_t gDir_{0}_t beta_{0}_t]
                    (integral 0. time_{0} 
                       [xRDR_{0}_0 xAIL_{0}_0 tau_{0}_0 r_{0}_0 psi_{0}_0 
                        phi_{0}_0 p_{0}_0 gRDR_{0}_0 gAIL_{0}_0 gDir_{0}_0 beta_{0}_0] flow_4)))))
"""]
